...
# 1- Nombre d'équivalent passager : mesure le total de ce qui est transporté:
# passagers + marchandises -> ne prend pas en compte la composition.
...
# 1 - Séries annuelles des Équivalents Passagers dans base LSN et CIE
# Base LSN
...
# Partie réutilisable qui concatène toutes les bases annuelles LSN ####
# Trouver tous les fichiers et con
...
# Fin de la partie réutilisable qui concatène les séries annuelles LSN####

# Agrégation : Somme de la colonne Peq par ANNEE
...
# Base CIE
# Partie réutilisable qui concatène toutes les bases annuelles CIE ####
...
# Le nombre annuel d'équivalent passagers est différent chaque année
# selon la base CIE (par compagnie) et LSN (par liaison)


# 2- Séries annuelles du nombre de passagers dans bases LSN et CIE
# Base LSN
# Trouver tous les fichiers
dossier_donnees_LSN = "data/traffic_aerien/asp-lsn-1990-2024/"
tous_les_fichiers_LSN = glob.glob(os.path.join(dossier_donnees_LSN, "ASP_LSN_*.csv"))
...
# Base CIE
# Trouver tous les fichiers
dossier_donnees_CIE = "data/traffic_aerien/asp-lsn-2010-2024/"
tous_les_fichiers_CIE = glob.glob(os.path.join(dossier_donnees_CIE, "ASP_CIE_*.csv"))
liste_df = []
